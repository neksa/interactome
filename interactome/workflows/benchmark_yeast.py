...
if __name__ == '__main__':
    ...
    multiroc(
        ...
        ('Binding site seq. similarity (Y2H)', 'Binding site seq. similarity (Gold set)', 'Interface compatibily score (Y2H)', 'Interface compatibility score (Gold set)'),
        roc_d + "/yeast_combined.eps",
        "Yeast, Y2H and Gold set")
